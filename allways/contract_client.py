...
class AllwaysContractClient:
    ...
    def _exec_logged(
        ...
        """Call ensure_initialized, exec_contract_raw, log, and return tx_hash."""
        self.ensure_initialized()
    ...
    def post_collateral(self, wallet: bt.Wallet, amount_rao: int) -> str:
        ...
        return self._exec_logged(wallet, 'post_collateral', 'Collateral posted', value=amount_rao)

    def withdraw_collateral(self, wallet: bt.Wallet, amount_rao: int) -> str:
        return self._exec_logged(wallet, 'withdraw_collateral', 'Collateral withdrawn', {'amount': amount_rao})
    ...
    def vote_extend_reservation(
        ...
        return self._exec_logged(
            wallet,
            'vote_extend_reservation',
            f'Vote extend reservation for miner {miner_hotkey}',
            {
                'request_hash': request_hash,
                'miner': miner_hotkey,
                'from_tx_hash': from_tx_hash,
    ...
    def vote_activate(self, wallet: bt.Wallet, miner_hotkey: str) -> str:
        ...
        return self._exec_logged(wallet, 'vote_activate', f'Vote activate for miner {miner_hotkey}', {'miner': miner_hotkey})
    ...
    def confirm_swap(self, wallet: bt.Wallet, swap_id: int) -> str:
        return self._exec_logged(wallet, 'confirm_swap', f'Swap {swap_id} confirmed', {'swap_id': swap_id})

    def timeout_swap(self, wallet: bt.Wallet, swap_id: int) -> str:
        return self._exec_logged(wallet, 'timeout_swap', f'Swap {swap_id} timed out', {'swap_id': swap_id})

    def deactivate_miner(self, wallet: bt.Wallet, miner: str) -> str:
        """Deactivate a miner directly on contract (permissionless)."""
        return self._exec_logged(wallet, 'deactivate', f'Miner {miner} deactivated', {'miner': miner})

    def claim_slash(self, wallet: bt.Wallet, swap_id: int) -> str:
        return self._exec_logged(wallet, 'claim_slash', f'Slash claimed for swap {swap_id}', {'swap_id': swap_id})
    ...
    def set_fulfillment_timeout(self, wallet: bt.Wallet, blocks: int) -> str:
        return self._exec_logged(wallet, 'set_fulfillment_timeout', f'Fulfillment timeout set to {blocks}', {'blocks': blocks})

    def set_min_collateral_amount(self, wallet: bt.Wallet, amount_rao: int) -> str:
        return self._exec_logged(wallet, 'set_min_collateral', f'Min collateral set to {amount_rao}', {'amount': amount_rao})

    def set_max_collateral_amount(self, wallet: bt.Wallet, amount_rao: int) -> str:
        return self._exec_logged(wallet, 'set_max_collateral', f'Max collateral set to {amount_rao}', {'amount': amount_rao})
    ...
    def set_min_swap_amount(self, wallet: bt.Wallet, amount_rao: int) -> str:
        return self._exec_logged(wallet, 'set_min_swap_amount', f'Min swap amount set to {amount_rao}', {'amount': amount_rao})

    def set_recycle_address(self, wallet: bt.Wallet, address: str) -> str:
        return self._exec_logged(wallet, 'set_recycle_address', f'Recycle address set to {address}', {'address': address})

    def set_reservation_ttl(self, wallet: bt.Wallet, blocks: int) -> str:
        return self._exec_logged(wallet, 'set_reservation_ttl', f'Reservation TTL set to {blocks}', {'blocks': blocks})

    def set_halted(self, wallet: bt.Wallet, halted: bool) -> str:
        return self._exec_logged(wallet, 'set_halted', f'System halted set to {halted}', {'halted': halted})

    def set_max_swap_amount(self, wallet: bt.Wallet, amount_rao: int) -> str:
        return self._exec_logged(wallet, 'set_max_swap_amount', f'Max swap amount set to {amount_rao}', {'amount': amount_rao})

    def add_validator(self, wallet: bt.Wallet, validator: str) -> str:
        return self._exec_logged(wallet, 'add_validator', f'Validator added {validator}', {'validator': validator})

    def remove_validator(self, wallet: bt.Wallet, validator: str) -> str:
        return self._exec_logged(wallet, 'remove_validator', f'Validator removed {validator}', {'validator': validator})

    def recycle_fees(self, wallet: bt.Wallet) -> str:
        return self._exec_logged(wallet, 'recycle_fees', 'Fees recycled')
